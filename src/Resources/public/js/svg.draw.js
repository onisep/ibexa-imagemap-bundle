...
import { extend as SVGextend, Element as SVGElement, on as SVGon, off as SVGoff } from '@svgdotjs/svg.js';
...
;(function () {
    ...
    PaintHandler.prototype.start = function (event) {
        ...
        SVGon(window, 'mousemove.draw', function (e) {
            _this.update(e);
        });
    ...
    SVGElement.prototype.draw.defaults = {
        snapToGrid: 1        // Snaps to a grid of `snapToGrid` px
    };

    SVGElement.prototype.draw.extend = function(name, obj){
        ...
        for(var shapes in plugins){
            ...
            for(var i in shapesArr){
                SVGElement.prototype.draw.plugins[shapesArr[i]] = plugins[shapes];
            }
        }
    ...
    SVGElement.prototype.draw.plugins = {};


    SVGElement.prototype.draw.extend('rect image', {
    ...
    SVGElement.prototype.draw.extend('line polyline polygon', {
        ...
        undo:function() {
            if (this.set.size) {
                this.set.entries().splice(-2, 1)[0].remove();
    ...
    SVGElement.prototype.draw.extend('circle', {
    ...
    SVGElement.prototype.draw.extend('ellipse', {
